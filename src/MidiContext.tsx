...
import { CanvasElement, FaderElement, FaderKeybind, FX_TARGET_CC_MAP, QUANTIZE_LENGTHS } from './types';
...
export const MidiProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <MidiContext.Provider value={{
      ...
      selectInput, selectOutput, refreshDevices, triggerElement, triggerFaderGlide, sendCC, sendPC,
